...
/**
 * Sends a PUT request to the api to change the media for the users avatar.
 */

export async function changeMedia(e) {
  e.preventDefault();
  ...
  try {
    const response = await fetch(
      `${baseUrl}/auction/profiles/${localStorage.getItem("name")}/media`,
      {
        method: "PUT",
        headers: {
